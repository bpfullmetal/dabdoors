...
if ( has_nav_menu( 'hoot-secondary' ) ) : // Check if there's a menu assigned to the 'secondary' location.
	...
	?>
	<h3 class="screen-reader-text"><?php _e( 'Secondary Navigation Menu', 'hoot-ubix-premium' ); ?></h3>
	<nav <?php hybridextend_attr( 'menu', 'secondary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'hoot-ubix-premium' ); ?></span><i class="fa fa-bars"></i></div>
