...
function hoot_theme_custom_image_sizes( $sizes ) {
	$sizes = array(
		...
		// 	'label'          => __( 'Small Thumbnail', 'hoot-ubix-premium' ),
		// 	'width'          => 315,
		// 	'height'         => 215,
		// 	'crop'           => true,
		...
		'hoot-medium-thumb' => array(
			'label'          => __( 'Medium Thumbnail', 'hoot-ubix-premium' ),
			'width'          => 420, // 240 x 183
		...
		'hoot-preview' => array(
			'label'          => __( 'Preview', 'hoot-ubix-premium' ),
			'width'          => 425,
			'height'         => 550,
			'crop'           => false,
			'show_in_editor' => false,
		...
		'hoot-large-thumb' => array(
			'label'          => __( 'Large Thumbnail', 'hoot-ubix-premium' ),
			'width'          => 550,
			'height'         => 400,
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-wide' => array(
			'label'          => __( 'Wide', 'hoot-ubix-premium' ),
			'width'          => 840, // 740x335
			'height'         => 385, // 740x335
			'crop'           => true,
			'show_in_editor' => false,
		...
		'hoot-extra-wide' => array(
			'label'          => __( 'Extra Wide', 'hoot-ubix-premium' ),
			'width'          => 945, // 740x300
			'height'         => 385, // 740x300
			'crop'           => true,
			'show_in_editor' => false,
