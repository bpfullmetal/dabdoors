...
function hoot_appearance_subpage() {
	...
	add_theme_page(
		__( 'Hoot Ubix Premium', 'hoot-ubix-premium' ),	// Page Title
		__( 'Premium Options', 'hoot-ubix-premium' ),	// Menu Title
...
function hoot_theme_appearance_subpage() {
	...
	$hoot_cta = ( empty( $hoot_cta ) ) ? '<a class="button button-primary button-buy-premium" href="https://wphoot.com/" target="_blank">' . __( 'Click here', 'hoot-ubix-premium' ) . '</a>' : $hoot_cta;
