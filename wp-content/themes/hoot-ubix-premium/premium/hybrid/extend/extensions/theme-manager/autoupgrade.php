...
class HybridExtend_Theme_Manager_Autoupgrade extends HybridExtend_Theme_Manager {
	...
	function print_autoupgrade() {
		...
		<div id="hybridextend-theme-mgr-autoupgrade" class="hybridextend-theme-mgr">
			...
			<p><?php _e( 'Enter your theme license key to enable theme updates directly via WordPress backend.<br />You can find your key at <a href="https://wphoot.com/?p=2" target="_blank">wphoot.com/downloads</a>.', 'hybrid-core' ); ?></p>
